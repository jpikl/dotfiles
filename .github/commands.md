...
- [clipboard](../.local/bin/clipboard) - Access clipboard contents.
...
- `fzfyay` - Fzf for yay package selection
...
- `paci` - Select packages to install using pacman/yay
- `pacii` - Select packages to install using pacman/yay (with refresh)
- `pacun` - Select packages to uninstall using pacman/yay
- `pacup` - Pacman/yay system upgrade
