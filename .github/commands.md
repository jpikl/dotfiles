...
- [git-mvn-prop](../.local/bin/git-mvn-prop) - Print property of a Maven project in Git branches.
...
- `cdplay` - Change directory to $USER_PLAYLISTS_DIR
...
- `mkdirpc` - Make directory including its parent and change into it
...
- `npmboot` - Install globaly the most essential npm packages
