...
alias cdmvndir='cd "$(findprj -mZ | choose -izp "Change working directory:")"'
alias cdmvnroot='cd "$(findprj -mu)"'
alias cdnpmdir='cd "$(findprj -nZ | choose -izp "Change working directory:")"'
alias cdnpmroot='cd "$(findprj -nu)"'
alias cdpic='cd "$PICTURES_DIR"'
alias cdplay='cd "$PLAYLISTS_DIR"'
alias cdplst='cdplay'
alias cdproj='cd "$WORKSPACE_DIR/$(find "$WORKSPACE_DIR" -mindepth 1 -maxdepth 1 -type d -printf "%P\0" | choose -izp "Go to workspace project:")"'
