...
# Home directories
export USER_BINARIES_DIR=${USER_BINARIES_DIR:-$HOME/.local/bin}
...
export USER_LIBRARIES_DIR=${USER_LIBRARIES_DIR:-$HOME/.local/lib}

# Runtime user directories
export USER_RUNTIME_DIR=${XDG_RUNTIME_DIR:-/run/user/$UID}
